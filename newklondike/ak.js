function showArrays()
{
	...
	/*	document.form1.shuffleDeck.value = shuffleDeck;
		document.form1.dealStack.value = dealStack;
		document.form1.aceStack.value = aceStack;
		document.form1.acevisibility.value = acevisibility;
		document.form1.colvisibility.value = colvisibility;
		
		*/
		if (shuffleDeck.length == 0) 
		{
		//document.form1.tferout.value = "Alomost Done";
		...
		if (shuffleDeck.length == 0 && dealStack.length == 0) 
		{
			//document.form1.tferout.value = "Alomost Done";
			checkFlip = 1;
			//visLen = colvisibility.length - 1;
			//document.form1.tferout.value = visLen;
			
			
			for (c=0;c<colvisibility.length;c++)
			{
				for (d=0;d<colvisibility[c].length;d++)
				{
					if (colvisibility[c][d] == "false")
					{
						checkFlip = 0;
					}
				}
			...
			if (checkFlip == 1)
			{
				//document.form1.tferout.value = "You did it!";
				document.images.loadbkg.style.left = 0;
				document.images.winner.style.left = 0;
			}
...
document.write(""
+"<img name='loadbkg' src='images/loadbkg.gif' width='320' height='480' border='0' STYLE='z-index: 99; position: absolute; top: 0; left: 0'>");


document.write(""
+"<img name='loading' src='images/loading.jpg' width='320' height='100' border='0' STYLE='z-index: 100; position: absolute; top: 100; left: 0'>");


document.write(""
+"<img name='beam' src='images/beam.jpg' width='20' height='20' border='0' STYLE='z-index: 101; position: absolute; top: 159; left: -200'>");

document.write(""
+"<img name='deck' src='images/spacerg.gif' width='40' height='54' border='0' STYLE='z-index: 1; position: absolute; top: 25; left: -200' onClick='threeMore()'>");

//ShowPile
document.write(""
+"<img name='deal2' src='images/spacer.gif' width='40' height='54' STYLE='z-index: 1; position: absolute; top: 25; left: -200' border='0' onClick='pickDeal(this.name)'>"
+"<img name='deal1' src='images/spacer.gif' width='40' height='54' border='0' STYLE='z-index: 1; position: absolute; top: 25; left: -200' onClick='pickDeal(this.name)'>"
+"<img name='deal0' src='images/spacer.gif' width='40' height='54' border='0' STYLE='z-index: 1; position: absolute; top: 25; left: -200' onClick='pickDeal(this.name)'>");
...
//AcePiles
document.write(""
+"<img name='ace0' src='images/spacerg.gif' width='40' height='54' border='0' STYLE='z-index: 1; position: absolute; top: 25; left: -200' onClick='moveToAce(0)'>"
+"<img name='ace1' src='images/spacerg.gif' width='40' height='54' border='0' STYLE='z-index: 1; position: absolute; top: 25; left: -200' onClick='moveToAce(1)'>"
+"<img name='ace2' src='images/spacerg.gif' width='40' height='54' border='0' STYLE='z-index: 1; position: absolute; top: 25; left: -200' onClick='moveToAce(2)'>"
+"<img name='ace3' src='images/spacerg.gif' width='40' height='54' border='0' STYLE='z-index: 1; position: absolute; top: 25; left: -200' onClick='moveToAce(3)'>");

document.write(""
+"<a href='http://www.iphonewebgames.com/iKlondike/'><img name='newgame' src='images/newgame.gif' width='80' height='20' border='0' STYLE='z-index: 1; position: absolute; top: 0; left: -200'></a>");

document.write(""
+"<a href='http://www.iphonewebgames.com/iKlondike/'><img name='winner' src='images/winner.jpg' width='320' height='100' border='0' STYLE='z-index: 100; position: absolute; top: 100; left: -400'></a>");
...
document.write("<!-- Game Field -->");
					...
					for(y = 0; y < cardstacks; ++y) 
					{
						...
						{
						document.write(""
+"<img name='colbase"+y+"' src='images/spacerg.gif' width='40' height='54' border='0' STYLE='z-index: 1; position: absolute; top: 76; left: -200' onClick='placeCard("+y+")'>");
						}
							document.write("<img name='col" + y + "_" + x + "' src='images/spacer.gif' border='0' width='40' height='54' STYLE='z-index: " + (x + 2) + "; position: absolute; top: 25; left: -200' onClick='pickCard("+y+","+x+")'>");
						}
					}
...
//alert("newGame");
	...
	"2S", "3S", 
	"AS", 
	"AH", "AC", "AD", "2H", "2C", "2D", "3H", "3C", "3D", "4H", "4C", "4D", "5H", "5C", "5D", "6H", "6C", "6D", "7H", "7C", "7D", "8H", "8C", "8D"];
	} else {
	shuffleDeck = [];
		for (i=0;i<52;++i)
		{
...
function placeCards()
{
	for (j=0;j<7;++j)
	{
		...
		for (k=j;k<7;++k)
		{
			colcards[k].push(shuffleDeck.splice(0,1));
				if (j == 0)
				{
				document.images["colbase"+k].style.top = 90;
				document.images["colbase"+k].style.left = colx[k];
				}
				document.images["col"+k+"_"+j].style.top = 90 + (j * 19);
	...
	document.images.deck.src = "images/Full/deal.gif";
	
document.images.newgame.style.left = 0;
document.images.deck.style.left = 5;
document.images.deal2.style.left = 50;
document.images.deal1.style.left = 60;
document.images.deal0.style.left = 70;
document.images.ace0.style.left = 140;
document.images.ace1.style.left = 185;
document.images.ace2.style.left = 230;
document.images.ace3.style.left = 275;
}
...
var aceAnimateFrame = 0;
function animateAce()
{	


					startX = document.images["col"+cardPickedCol+"_"+cardPickedRow].style.left;
					startX = Number(startX.replace("px",""));
					startY = document.images["col"+cardPickedCol+"_"+cardPickedRow].style.top;
					startY = Number(startY.replace("px",""));
					endX = acex[aceColPicked];
					endY = 25;
					divX = (endX - startX) /10;
					divY = (endY - startY) /10;
					//for (h=1;h<10;++h)
					//{
						nowX = startX + (divX * aceAnimateFrame);
						document.images["col"+cardPickedCol+"_"+cardPickedRow].style.left = nowX
						document.images["col"+cardPickedCol+"_"+cardPickedRow].style.top = startY + (divY * aceAnimateFrame);
						//delay(50);
						//alert(endX + "," + startX + "," + divX);
						//nowX = 0;
					//}
					if (aceAnimateFrame < 10) 
					{
						
						aceAnimateFrame++;
						//alert(aceAnimateFrame);
						setAnimateAce();
					} else {
						self.clearInterval(t);
						alert(aceAnimateFrame);
						finishAce(aceColPicked);
						
					}
	
	
}
function setAnimateAce()
{
	t=self.setInterval("animateAce()",200);			
}
function finishAce(aceCol)
{
	...
	//alert(aceCol);
					...
					//document.images["col"+cardPickedCol+"_"+cardPickedRow].style.top = 300;
...
function pickDeal(dealCard)
{
	if (cardPicked == 0)
	{
		...
		if (ipName == dealStack[(dealStack.length - 1)])
		{
				...
				document.images.ind.style.top = 25;
